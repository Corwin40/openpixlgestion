 ...
 */
final class Version20230126101400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_service (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, client_id INT DEFAULT NULL, service VARCHAR(255) NOT NULL, time VARCHAR(7) DEFAULT NULL, price VARCHAR(5) DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, created_at DATE NOT NULL, updated_at DATE NOT NULL, INDEX IDX_F99CC108F675F31B (author_id), INDEX IDX_F99CC10819EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE statut (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, notes LONGTEXT NOT NULL, price NUMERIC(6, 2) NOT NULL, hours VARCHAR(20) NOT NULL, author VARCHAR(20) NOT NULL, started_at VARCHAR(20) NOT NULL, finished_at VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
